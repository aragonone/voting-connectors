...
},{"../internals/export":"rhEq","../internals/is-pure":"tGwT","../internals/global":"MVLi","../internals/path":"hMfB","../internals/native-promise-constructor":"O8N5","../internals/redefine":"ztZs","../internals/redefine-all":"oPIw","../internals/set-to-string-tag":"kLCt","../internals/set-species":"bDBP","../internals/is-object":"AsqF","../internals/a-function":"SOPX","../internals/an-instance":"pJoy","../internals/classof-raw":"jUdy","../internals/iterate":"Oj1G","../internals/check-correctness-of-iteration":"XOlJ","../internals/species-constructor":"mxIp","../internals/task":"g1no","../internals/microtask":"jLqr","../internals/promise-resolve":"S6uO","../internals/host-report-errors":"xiDB","../internals/new-promise-capability":"NKSu","../internals/perform":"coA3","../internals/user-agent":"eUSx","../internals/internal-state":"vLSK","../internals/is-forced":"Y6Gi","../internals/well-known-symbol":"Q0EA"}],"i5OW":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
var aFunction = require('../internals/a-function');
var newPromiseCapabilityModule = require('../internals/new-promise-capability');
...
},{"../internals/export":"rhEq","../internals/is-pure":"tGwT","../internals/native-promise-constructor":"O8N5","../internals/get-built-in":"mLk8","../internals/species-constructor":"mxIp","../internals/promise-resolve":"S6uO","../internals/redefine":"ztZs"}],"eBDp":[function(require,module,exports) {
...
function debug() {
  ...
  "production" !== "production" && (_console = console).debug.apply(_console, arguments);
...
function _objectSpread(target) {
  for (var source, i = 1; i < arguments.length; i++) {
    source = null == arguments[i] ? {} : arguments[i], i % 2 ? ownKeys(source, !0).forEach(function (key) {
  ...
  _createClass(AppProxy, [{
    ...
    */
    ...
    value: function store(reducer) {
      ...
      var wrappedReducer = function (state, event) {
        ...
        new Promise(function (resolve) {
          ...
          getCurrentEvents = function (fromBlock) {
        return (0, _rxjs.merge).apply(void 0, [_this2.events({
          fromBlock: fromBlock
        })].concat(_toConsumableArray(externals.map(function (_ref3) {
          ...
          getPastEvents = function (cachedFromBlock, toBlock) {
        return (0, _rxjs.merge).apply(void 0, [_this2.pastEvents({
          ...
          var contract = _ref4.contract,
              initializationBlock = _ref4.initializationBlock;
      ...
      (0, _operators.map)(function (v) {
        return v || {};
          ...
          initState$ = init ? cacheValue$.pipe((0, _operators.switchMap)(function (_ref5) {
        ...
        return (0, _utils.debug)("- store - init state:", initState), _this2.cache("state", initState);
          ...
          store$ = (0, _rxjs.forkJoin)(cacheValue$, initState$, latestBlock$).pipe((0, _operators.switchMap)(function (_ref6) {
        ...
        (0, _utils.debug)("- store - initial store state", initialStoreState), (0, _utils.debug)("- store - cachedBlock ".concat(cachedBlock, " | latestBlock: ").concat(latestBlock));

        var pastEventsToBlock = _Mathmax(0, latestBlock - 100);

        return void 0 === cachedBlock ? (0, _utils.debug)("- store - pastEvents: initialization block -> ".concat(pastEventsToBlock, " (up to ").concat(pastEventsToBlock, " blocks)")) : (0, _utils.debug)("- store - pastEvents: block ".concat(cachedBlock, " -> ").concat(pastEventsToBlock, " (").concat(pastEventsToBlock - cachedBlock, " blocks)")), (0, _utils.debug)("- store - currentEvents$: block ".concat(pastEventsToBlock, " -> future")), getPastEvents(cachedBlock, pastEventsToBlock).pipe((0, _operators.mergeScan)(wrappedReducer, initialStoreState, 1), // throttle to reduce rendering and caching overthead
        // must keep trailing to avoid discarded events
        (0, _operators.throttleTime)(1e3, _rxjs.asyncScheduler, {
          leading: !1,
          trailing: !0
        }), (0, _operators.delayWhen)(function (state) {
          return (0, _utils.debug)("- store - reduced state from past event:", state), _this2.cache("state", state);
        }), (0, _operators.last)(), (0, _operators.delayWhen)(function (state) {
          return (0, _utils.debug)("caching state:", state), _this2.cache("CACHED_STATE_KEY", {
            block: pastEventsToBlock,
            state: state
          });
        }), (0, _operators.switchMap)(function (pastState) {
          // observable which emits an web3.js event-like object with the address of the active account.
          var accounts$ = _this2.accounts().pipe((0, _operators.map)(function (accounts) {
            return {
              ...
              currentEvents$ = getCurrentEvents(pastEventsToBlock + 1); // fetch current events from block after cached block
        ...
        (0, _operators.throttleTime)(250, _rxjs.asyncScheduler, {
          ...
          return (0, _utils.debug)("- store - reduced state:", state), _this2.cache("state", state);
        }));
...
},{"@babel/runtime/helpers/interopRequireWildcard":"t7py","@babel/runtime/helpers/interopRequireDefault":"SpGf","@babel/runtime/helpers/defineProperty":"IxO8","@babel/runtime/helpers/objectWithoutProperties":"U8F3","rxjs":"iRqj","rxjs/operators":"cVrl","@aragon/rpc-messenger":"Cvad","./utils":"aH99"}],"vkiE":[function(require,module,exports) {
module.exports = [{
  "constant": true,
  "inputs": [],
  "name": "name",
...
var TokenAbi = require('./abi/minimeToken.json');

var app = new _api.default();
